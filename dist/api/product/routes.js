...
class ProductRoutes {
    ...
    static get routes() {
        ...
        router.post(`${this.mainRoute}/create`, [(0, validate_request_middleware_1.validate)(create_product_controller_1.createProductSchema), auth_middleware_1.authMiddleware], product_controller_1.productController.create);
        ...
        router.put(`${this.mainRoute}/update`, [(0, validate_request_middleware_1.validate)(update_product_schema_1.updateProductSchema), auth_middleware_1.authMiddleware], product_controller_1.productController.update);
        router.delete(`${this.mainRoute}/delete/:id`, [auth_middleware_1.authMiddleware], product_controller_1.productController.delete);
        return router;
    }
}
