...
class CartEntity {
    ...
    cartStatus;
    cartDetail;
    constructor(id, total, subTotal, subTotalDiscount, subTotalTax, discount, tax, userId, cartStatusId, createdAt, updatedAt, user, cartStatus, cartDetail) {
        this.id = id;
        this.total = total;
